<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\php\lqweb\application\admin/template/admin\index\main.html";i:1500531673;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="row">
    ...
    <div class="sysNotice col">
        ...
        <table class="layui-table">
            ...
            <tr>
                <td>服务器环境</td>
                <td class="server"><?php echo $server; ?></td>
            </tr>
            <tr>
                <td>数据库版本</td>
...
<!--<script type="text/javascript" src="__PUBLIC__js/main.js"></script>-->
</body>
</html>