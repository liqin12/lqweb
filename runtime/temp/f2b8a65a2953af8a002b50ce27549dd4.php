<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\php\lqweb\application\admin/template/admin\goods\add_goods.html";i:1501314266;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel margin-top">
    ...
    <div class="body-content">
        <form method="post" enctype="multipart/form-data" class="form-x"
              action="<?php echo url('goods_hendel'); ?>" onsubmit="return check()">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <select name="cate_id" id="cate_name" class="input w50">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" id="name" name="price" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" id="name" name="img" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
